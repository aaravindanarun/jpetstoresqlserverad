...
ADD ./src/main/resources/database/jpetstore-hsqldb-dataload.sql   /docker-entrypoint-initdb.d/02_jpetstore-hsqldb-dataload.sql
ADD ./src/main/resources/database/jpetstore-hsqldb-schema.sql   /docker-entrypoint-initdb.d/01_jpetstore-hsqldb-schema.sql
